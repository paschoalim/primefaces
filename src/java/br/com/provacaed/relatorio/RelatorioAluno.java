 ...
 */
package br.com.provacaed.relatorio;
...
public class RelatorioAluno {
    ...
    */
    public void getRelatorio(List<Aluno> lista){
        stream = this.getClass().getResourceAsStream("/Report/RelatorioAluno.jasper");
        ...
        try {
            ...
            JasperPrint print;
            print = JasperFillManager.fillReport(report, params, new JRBeanCollectionDataSource(lista, false));
